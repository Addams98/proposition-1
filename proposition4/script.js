// PROPOSITION 4 — Shared JavaScript (Warm theme)
'use strict';
...
btt.style.cssText = 'position:fixed;bottom:1.5rem;right:1.5rem;z-index:900;width:42px;height:42px;border-radius:50%;background:var(--terra);color:#fff;border:none;cursor:pointer;font-size:0.9rem;box-shadow:0 4px 14px rgba(194,65,12,0.35);display:none;align-items:center;justify-content:center;';
